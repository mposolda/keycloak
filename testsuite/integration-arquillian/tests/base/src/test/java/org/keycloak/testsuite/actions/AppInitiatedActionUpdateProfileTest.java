...
/**
 * TODO:mposolda maybe update this javadoc if "RequiredActionUpdateProfileWithUserProfileTest" will be removed... (not yet sure if it is good to remove it or not)
 *
