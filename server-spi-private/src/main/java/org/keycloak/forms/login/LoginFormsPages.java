...
public enum LoginFormsPages {
    ...
    OAUTH_GRANT, LOGIN_RESET_PASSWORD, LOGIN_UPDATE_PASSWORD, LOGIN_SELECT_AUTHENTICATOR, REGISTER, REGISTER_USER_PROFILE, INFO, DETACHED_INFO, ERROR, ERROR_WEBAUTHN, LOGIN_UPDATE_PROFILE,
