...
public class DefaultTokenContextEncoderProviderTest {
    ...
    public void before() {
        ...
        provider = new DefaultTokenContextEncoderProvider(null, factory.sessionTypesByShortcut, factory.tokenTypesByShortcut, factory.grantsByShortcuts, factory.grantsToShortcuts);
    }
