...
public class DefaultTokenContextEncoderProvider implements TokenContextEncoderProvider {
    ...
    private final Map<String, AccessTokenContext.SessionType> sessionTypesByShortcut;
    private final Map<String, AccessTokenContext.TokenType> tokenTypesByShortcut;
    private final Map<String, String> grantsByShortcuts;
    private final Map<String, String> grantsToShortcuts;
    ...
    public DefaultTokenContextEncoderProvider(KeycloakSession session,
        ...
        this.sessionTypesByShortcut = sessionTypesByShortcut;
        this.tokenTypesByShortcut = tokenTypesByShortcut;
        this.grantsByShortcuts = grantsByShortcuts;
        this.grantsToShortcuts = grantsToShortcuts;
    }
            ...
            for (String chunk : chunks) {
                ...
                switch (prefix) {
                    case SESSION_TYPE_PREFIX:
                        st = sessionTypesByShortcut.get(value);
                        if (st == null) {
                    ...
                    case TOKEN_TYPE_PREFIX:
                        tt = tokenTypesByShortcut.get(value);
                        if (tt == null) {
                    ...
                    case GRANT_TYPE_PREFIX:
                        gt = grantsByShortcuts.get(value);
                        if (gt == null) {
